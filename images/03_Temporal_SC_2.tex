...
\begin{figure}[!ht]
    \centering
    \includegraphics{images/chapter_3/modmul.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.25]{images/chapter_3/vispow10.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics{images/chapter_3/appliedCrypt.jpg}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.4]{images/chapter_3/ltrbe.png}
...
by $g$, $A=A*g$. This is the algorithm. You can see the algorithm flow in \Cref{fig:ltrbe-flow}.
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.4]{images/chapter_3/smartcard.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.3]{images/chapter_3/extraRed.PNG}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.3]{images/chapter_3/extraStat.PNG}
...
\begin{figure}[!ht]
    \centering
    \fbox{
    \includegraphics[scale=0.5]{images/chapter_3/defmat.png}}
...
\begin{figure}[!ht]
    \centering
    \fbox{
    \includegraphics[scale=0.5]{images/chapter_3/defmat2.png}}
...
\begin{figure}[!ht]
    \centering
    \fbox{
    \includegraphics[scale=0.5]{images/chapter_3/defmat3.png}}
...
\begin{figure}[!ht]
    \centering
    \fbox{
    \includegraphics[scale=0.6]{images/chapter_3/defmat4.png}}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.6]{images/chapter_3/defmatplot.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.25]{images/chapter_3/figpita.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.25]{images/chapter_3/paul.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.15]{images/chapter_3/saama.png}
